      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          {(hasVariant(globalVariants, "screen", "mobile") ? true : false) ? (
            <div className={classNames(projectcss.all, sty.columns__idk5D)}>
              <div className={classNames(projectcss.all, sty.column__hElT)}>
                <PlasmicLink__
                  className={classNames(
                    projectcss.all,
                    projectcss.a,
                ...
                >
                  <ArrowLeftSvgrepoComsvgIcon
                    className={classNames(projectcss.all, sty.svg__hxsgn)}
                    role={"img"}
                  />
              ...
              <div className={classNames(projectcss.all, sty.column__wmZY)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
          ...
          <section className={classNames(projectcss.all, sty.section__pep1O)}>
            <Embed
                ...
                return (
                  ...
                  >
                    ...
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField___95A2T
                      )}
                      hidden={false}
                      label={"Telepon"}
                    >
                      <AntdInput
                        className={classNames("__wab_instance", sty.input__jSw)}
                      />
                    </FormItemWrapper>
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__apYXn
                      )}
                      label={"Message"}
                      name={"message"}
                    >
                    ...
                    <AntdButton
                      className={classNames("__wab_instance", sty.button__dT4E)}
                      submitsForm={true}
                      type={"primary"}
                    >
                      <div
