          ...
          <section className={classNames(projectcss.all, sty.section__sYvNp)}>
            <AntdTabs
              ...
              items={
                <React.Fragment>
                  <AntdTabItem
                    className={classNames("__wab_instance", sty.tabItem__ggYkM)}
                    key={"1"}
                    label={
                      <div
                        className={classNames(
                  ...
                  <AntdTabItem
                    className={classNames("__wab_instance", sty.tabItem__sqPrw)}
                    key={"2"}
                    label={
                      <div
                        className={classNames(
                  ...
                  <AntdTabItem
                    className={classNames("__wab_instance", sty.tabItem__pb2Ii)}
                    key={"3"}
                    label={
                      <div
                        className={classNames(
