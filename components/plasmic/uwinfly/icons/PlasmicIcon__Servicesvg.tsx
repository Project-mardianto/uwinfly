...
export type ServicesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ServicesvgIcon(props: ServicesvgIconProps) {
  ...
  return (
    ...
    >
      ...
      <path d={"M1000 1000H0V0h1000z"} opacity={".8"} fill={"#fff"}></path>

      <path
        d={"M117 469.7H40v115.2h77v4.4h80.4V423.4H117zm117 8.5v102.4h68V478.2z"}
        opacity={".4"}
        fill={"#3f4442"}
      ></path>
      ...
      <path d={"M1000 1000H0V687.5h1000z"} fill={"#939393"}></path>
      ...
      <path d={"M774.3 600.5l-64.4 21.6-27.6-16.3z"} fill={"#666"}></path>

      <path
        d={
          "M638.8 600.5c0 3.6 3.1 6.5 7 6.5h162.4c3.9 0 7-2.9 7-6.5 0-3.7-3.1-6.6-7-6.6H645.8c-3.9 0-7 2.9-7 6.6z"
        }
        fill={"#898989"}
      ></path>

      <path d={"M808.2 593.9H644.1V476.8h164.1z"} fill={"#ff0100"}></path>

      <use
        href={"#XvBTt1exom9Ia"}
        transform={"matrix(.195 0 0 .195 681.069 499.069)"}
      ></use>
      ...
      <path
        d={"M808.2 511.4H644.1v-3.2h164.1zm7 13.8h-7v-24.3h7z"}
        fill={"#e80807"}
      ></path>
