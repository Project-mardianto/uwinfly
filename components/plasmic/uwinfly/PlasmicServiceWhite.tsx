...
import BlueBdr from "../../BlueBdr"; // plasmic-import: wyo2rRUWPFm0/component
...
import sty from "./PlasmicServiceWhite.module.css"; // plasmic-import: X6vipW5zRPRU/css
...
function PlasmicServiceWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox___9XvNc)}>
        {renderPlasmicSlot({
          defaultContents: (
            <BlueBdr
              className={classNames("__wab_instance", sty.blueBdr__m7CsW)}
            />
          ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__z1Obo)}>
        {renderPlasmicSlot({
          defaultContents:
