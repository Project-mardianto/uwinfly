...
import sty from "./PlasmicSocialIcons.module.css"; // plasmic-import: P0-C-lOgntj5/css
...
function PlasmicSocialIcons__RenderFunc(props: {
  ...
  return (
    ...
    >
      <IconIcon
        className={classNames(projectcss.all, sty.svg___0Twnw)}
      ...
      <Icon2Icon
        className={classNames(projectcss.all, sty.svg__mPnFu)}
        role={"img"}
      />

      <Icon3Icon
        className={classNames(projectcss.all, sty.svg__e5Py4)}
        role={"img"}
      />
    </Stack__>
