...
import sty from "./PlasmicButton.module.css"; // plasmic-import: f3lmI1Q2JQuQ/css
...
export type PlasmicButton__VariantMembers = {
  ...
  shape: "rounded" | "round" | "unnamedVariant";
...
export type PlasmicButton__VariantsArgs = {
  ...
  shape?: SingleChoiceArg<"rounded" | "round" | "unnamedVariant">;
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__o9Ul)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nuUKy)}
                role={"img"}
              />
            ),
