    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(projectcss.all, sty.freeBox__dsUx6)}>
            <div className={classNames(projectcss.all, sty.freeBox___7VziD)}>
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__xbd65)}
              >
                <div className={classNames(projectcss.all, sty.column__lVv0J)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img___7ZhuI)}
                    displayHeight={
                      hasVariant(globalVariants, "screen", "mobile")
                        ? "172px"
                        : "322px"
                ...
                <div className={classNames(projectcss.all, sty.column__wcIu3)}>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__zAlb5)}
                  >
                    <h2
                    ...
                    <section
                      className={classNames(projectcss.all, sty.section__xN03T)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
